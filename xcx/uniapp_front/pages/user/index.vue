		...
		<view v-else>
			...
			<view class="stats-section">
				<view class="stat-item">
					<text class="stat-number" :style="statNumberStyle">{{ orderStats.sent }}</text>
					<text class="stat-label">发出订单</text>
				</view>
				<view class="stat-item">
					<text class="stat-number" :style="statNumberStyle">{{ orderStats.received }}</text>
					<text class="stat-label">收到订单</text>
				</view>
				<view class="stat-item">
					<text class="stat-number" :style="statNumberStyle">{{ orderStats.total }}</text>
