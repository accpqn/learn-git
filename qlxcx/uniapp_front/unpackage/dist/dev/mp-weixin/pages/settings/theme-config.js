  ...
  setup() {
    ...
    common_vendor.onShow(() => {
      try {
        ...
        common_vendor.index.__f__("log", "at pages/settings/theme-config.vue:115", "设置导航栏主题失败:", error);
      }
    });
    ...
    const saveThemeConfigData = async () => {
      ...
      try {
        ...
        common_vendor.index.__f__("error", "at pages/settings/theme-config.vue:180", "保存主题失败:", error);
        common_vendor.index.showToast({
          title: "主题已保存到本地",
          icon: "success"
        });
