  ...
  setup() {
    ...
    common_vendor.onShow(() => {
      try {
        ...
        common_vendor.index.__f__("log", "at pages/settings/menu-manage.vue:221", "设置导航栏主题失败:", error);
      }
    });
    const loadData = async () => {
      ...
      try {
        ...
        common_vendor.index.__f__("error", "at pages/settings/menu-manage.vue:234", "加载数据失败:", error);
    ...
    const loadCategories = async () => {
      try {
        ...
        common_vendor.index.__f__("error", "at pages/settings/menu-manage.vue:250", "加载分类失败:", error);
      }
    };
    const loadProducts = async () => {
      try {
        ...
        common_vendor.index.__f__("error", "at pages/settings/menu-manage.vue:260", "加载商品失败:", error);
      }
    };
    ...
    const showAddCategoryModal = () => {
      common_vendor.index.__f__("log", "at pages/settings/menu-manage.vue:287", "显示添加分类弹窗");
      resetCategoryForm();
    ...
    const saveCategoryModal = async () => {
      common_vendor.index.__f__("log", "at pages/settings/menu-manage.vue:309", "保存分类开始", categoryForm);
      ...
      try {
        ...
        common_vendor.index.__f__("log", "at pages/settings/menu-manage.vue:323", "准备发送的数据:", data);
        if (categoryForm.id) {
          common_vendor.index.__f__("log", "at pages/settings/menu-manage.vue:327", "编辑分类:", categoryForm.id);
          ...
          common_vendor.index.__f__("log", "at pages/settings/menu-manage.vue:335", "新增分类");
          const result = await api_menu.addCategory(data);
          common_vendor.index.__f__("log", "at pages/settings/menu-manage.vue:337", "新增分类结果:", result);
          common_vendor.index.showToast({
            title: "分类添加成功",
            icon: "success"
          });
        ...
        common_vendor.index.__f__("error", "at pages/settings/menu-manage.vue:347", "保存分类失败:", error);
        common_vendor.index.showToast({
        ...
        success: async (res) => {
          if (res.confirm) {
            try {
              ...
              common_vendor.index.__f__("error", "at pages/settings/menu-manage.vue:381", "删除分类失败:", error);
              common_vendor.index.showToast({
                title: "删除失败",
                icon: "error"
              });
    ...
    const showAddProductModal = (categoryId = null) => {
      common_vendor.index.__f__("log", "at pages/settings/menu-manage.vue:396", "显示添加商品弹窗", categoryId);
    ...
    const handleCategoryChange = (e) => {
      ...
      common_vendor.index.__f__("log", "at pages/settings/menu-manage.vue:444", "分类选择变化:", index, productForm.category);
    };
    const chooseImage = () => {
      common_vendor.index.chooseImage({
        ...
        success: (res) => {
          ...
          common_vendor.index.__f__("log", "at pages/settings/menu-manage.vue:456", "选择图片:", res.tempFilePaths[0]);
        },
        fail: (error) => {
          common_vendor.index.__f__("error", "at pages/settings/menu-manage.vue:459", "选择图片失败:", error);
    ...
    const uploadProductWithImage = (productId, data, imagePath, isUpdate) => {
      return new Promise((resolve, reject) => {
        ...
        common_vendor.index.uploadFile({
          ...
          success: (res) => {
            common_vendor.index.__f__("log", "at pages/settings/menu-manage.vue:504", "上传成功:", res);
          ...
          fail: (error) => {
            common_vendor.index.__f__("error", "at pages/settings/menu-manage.vue:512", "上传失败:", error);
            reject(error);
          }
        });
      });
    ...
    const saveProductModal = async () => {
      common_vendor.index.__f__("log", "at pages/settings/menu-manage.vue:521", "保存商品开始", productForm);
      ...
      try {
        ...
        common_vendor.index.__f__("log", "at pages/settings/menu-manage.vue:555", "准备发送的商品数据:", baseData);
        if (productForm.id) {
          common_vendor.index.__f__("log", "at pages/settings/menu-manage.vue:559", "编辑商品:", productForm.id);
          ...
          common_vendor.index.__f__("log", "at pages/settings/menu-manage.vue:575", "新增商品");
          if (productForm.imageFile) {
        ...
        common_vendor.index.__f__("error", "at pages/settings/menu-manage.vue:594", "保存商品失败:", error);
        common_vendor.index.showToast({
          title: "保存失败: " + (error.message || "未知错误"),
          icon: "error"
        });
        ...
        success: async (res) => {
          if (res.confirm) {
            try {
              ...
              common_vendor.index.__f__("error", "at pages/settings/menu-manage.vue:623", "删除商品失败:", error);
              common_vendor.index.showToast({
                title: "删除失败",
                icon: "error"
              });
